    ...
    postLike[i].addEventListener("click", (e) => {
        ...
        xhr.onreadystatechange = function () {
            if (this.readyState === 4 && this.status === 200) {
                ...
                postLikeCount[i].innerHTML = Number(postLikeCount[i].innerHTML) + Number(response.val);
        ...
        xhr.open("GET", `http://localhost:5000/profile/likePost/${postIds[i].value}/${currentPage[i].value}`)
